...
export interface CustomerFavorite
  extends Omit<Product, 'category' | 'nutrition'> {
  tags: string[];
}
...
export const customerFavorites: CustomerFavorite[] = [
  {
    ...
    description:
      'Bring a friend with you on Mondays and enjoy a $2.50 margarita!',
    price: 2.5,
    tags: ['21+'],
  },
  {
    ...
    description:
      'Saturdays just for you! Join us for live music and half off drinks from 6pm to 10pm!',
    price: 14.99,
  ...
  },
  {
    ...
    imageUrl: partyImg,
    description:
      'Make your after hours experience unforgettable with our casino-style games and live music!',
    price: 12.99,
  ...
  },
  {
    ...
    description:
      'Catch us at the uptown nightlife area on Fridays when we take our show on the road.',
    price: 0,
    tags: ['Free'],
  },
];
